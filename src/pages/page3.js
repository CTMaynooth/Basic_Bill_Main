  ...
  render() {
    return (
      <div>
        ...
        <button className="btn btn-info ml-1" onClick={this.add}>
          add new invoice
        </button>
        <p>&nbsp;</p>
        <div>
        ...
        <div id="messageBox">
          ...
          /> */}
          <button className="btn btn-primary" onClick={this.yesBtnClick}>
            Yes
          </button>
          {/* <img
            id="noBtn"
        ...
        <div id="editBox">
          ...
          /> */}
          <button className="btn btn-primary ml-2" onClick={this.yesBtnClick}>
            Yes{" "}
          </button>
        </div>
      </div>
